...
import { Leaf, ShieldCheck, Truck, Award, Clock, FlaskConical, MapPin, Zap, ArrowRight } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="shimmer glow-border p-8 rounded-2xl bg-[#0e0e0e] border border-white/[0.06]">
            ...
            <h3 className="text-lg font-bold mb-3">SoCal Roots</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
          ...
          <div className="relative p-8 sm:p-12 rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid sm:grid-cols-3 gap-3">
                ...
                <div className="p-5 rounded-xl bg-white/[0.02] border border-white/[0.06] text-center">
                  <div className="text-2xl font-black text-[#39FF14]">$75+</div>
                  <div className="text-[10px] text-gray-500 mt-1 uppercase tracking-wider">Free Delivery</div>
                </div>
                <div className="p-5 rounded-xl bg-white/[0.02] border border-white/[0.06] text-center">
        ...
        >
          ...
          <p className="text-gray-400 mb-8 max-w-md mx-auto text-sm">Browse our terpene-focused menu and get premium cannabis delivered to your door in under an hour.</p>
