...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    in_stock: true,
    badge: 'Best Seller',
    weights: { eighth: 25, q: 45, h: 75, oz: 140 },
  },
  {
    id: 'gushers',
    name: 'Gushers',
    ...
    price: 30,
    thc: '29%+',
    description: 'Gushers brings that fruity, candy-like flavor with every hit. Dense, trichome-loaded buds with tropical and sweet notes that smack. A cross that delivers heavy euphoria and full-body relaxation, top-shelf quality that speaks for itself.',
    in_stock: true,
    weights: { eighth: 30, q: 50, h: 85, oz: 160 },
  },
  {
    id: 'sherblato',
    name: 'Sherblato',
  ...
  },
  {
    ...
    price: 35,
    thc: '31%+',
    description: 'Sakura is a rare exotic with a smooth, floral terpene profile that stands out from everything else. Beautiful frosty nugs with a sweet, almost cherry-blossom finish. Cerebral and uplifting, perfect for the connoisseur who wants something different.',
    in_stock: true,
    brand: 'Foreign',
    weights: { eighth: 35, q: 60, h: 95, oz: 180 },
  },
  {
    id: 'lcg',
    name: 'LCG',
