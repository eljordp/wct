...
export const WHOLESALE_PRODUCTS: WholesaleProduct[] = [
  ...
  },
  {
    ...
    thc: '34%+',
    description: 'Foreign Wendy is an exclusive drop: limited supply, heavy demand. Exotic terpene profile with an electric high that stands out from everything else on the market.',
    image_url: '',
    in_stock: true,
    badge: 'Exclusive',
    brand: 'Foreign',
  ...
  },
  {
    ...
    retail: 80,
    wholesale: [
      { minQty: 25, price: 50, label: '25+ units' },
      { minQty: 100, price: 40, label: '100+ units' },
      { minQty: 250, price: 32, label: '250+ units' },
    ],
    thc: '90%+',
    description: 'The Lean Cup Cart: smooth, potent, and built different. Premium oil in a sleek cart that delivers every time. If you know, you know.',
    image_url: '',
    in_stock: true,
    badge: 'Limited',
    minOrder: 25,
