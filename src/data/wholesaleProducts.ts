...
export const WHOLESALE_PRODUCTS: WholesaleProduct[] = [
  {
    ...
    brand: 'WCT',
    wholesale: [
      { minQty: 10, price: 100, label: '10+ bags' },
      { minQty: 50, price: 85, label: '50+ bags' },
      { minQty: 100, price: 70, label: '100+ bags' },
    ],
    thc: '26%+',
  ...
  },
  {
    ...
    retail: 140,
    wholesale: [
      { minQty: 10, price: 140, label: '10+ bags' },
      { minQty: 50, price: 120, label: '50+ bags' },
      { minQty: 100, price: 100, label: '100+ bags' },
    ],
    thc: '28%+',
  ...
  },
  {
    ...
    retail: 160,
    wholesale: [
      { minQty: 10, price: 160, label: '10+ bags' },
      { minQty: 50, price: 135, label: '50+ bags' },
      { minQty: 100, price: 115, label: '100+ bags' },
    ],
    thc: '29%+',
  ...
  },
  {
    ...
    retail: 180,
    wholesale: [
      { minQty: 10, price: 180, label: '10+ bags' },
      { minQty: 50, price: 155, label: '50+ bags' },
      { minQty: 100, price: 130, label: '100+ bags' },
    ],
    thc: '31%+',
  ...
  },
  {
    ...
    retail: 200,
    wholesale: [
      { minQty: 10, price: 200, label: '10+ bags' },
      { minQty: 50, price: 170, label: '50+ bags' },
      { minQty: 100, price: 145, label: '100+ bags' },
    ],
    thc: '34%+',
