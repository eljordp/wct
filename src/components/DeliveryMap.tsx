...
// Inland boundary — opens into a wide blob around the LA basin
const INLAND_PATH = 'M 25,15 C 60,8 90,5 115,8 C 148,14 178,25 202,35 C 225,45 255,55 290,60 C 340,68 400,75 440,95 C 470,112 490,170 492,230 C 493,270 490,300 480,310 C 485,314 490,314 495,314'

// Closed zone fill: coast forward, then inland boundary reversed
const ZONE_FILL = 'M 25,55 C 60,50 88,46 110,48 C 132,50 155,55 175,66 C 188,74 196,80 202,88 C 208,96 210,104 212,112 C 216,124 224,136 235,148 C 250,162 262,170 272,174 C 286,179 306,180 328,182 C 342,183 350,185 354,192 C 356,202 356,218 356,235 C 356,252 354,266 346,280 C 336,296 330,306 336,314 C 344,322 362,320 385,316 C 402,312 425,306 448,306 C 465,306 480,310 495,314 C 490,314 485,314 480,310 C 493,270 492,230 490,170 C 470,112 440,95 400,75 C 340,68 290,60 255,55 C 225,45 202,35 178,25 C 148,14 115,8 90,5 C 60,8 25,15 25,15 L 25,55 Z'
